...
//# Hook 함수 :
// - react에서 컴포넌트의 상태와 '생명주기'에 따라 특정 작업을 수행하도록 하는 특별한 함수
// - use로 시작하는 함수
...
// - useRef : 특정한 상태를 기억하기 위한 함수, 값이 변경되더라도 렌더링을 수행하고 싶지 않을 때, 
//            DOM 요소를 기억하고 싶을 때 사용
// - useContext : 컴포넌트 트리 상에서 전역적으로 상태를 공유하고자 할 때 사용하는 함수
// - useReducer : 상태 로직을 관리하는 함수, 
//                상태 업데이트 로직을 컴포넌트 외부로 옮길 수 있게하여 코드관리를 수월하게 도와줌
...
export default function HookComponent1() {
    ...
    // 스코프할 상태 배열에 2개 이상의 상태를 지정할 수 있음
...
function SubComponent() {
    ...
    // 전달한 콜백 함수에 'return'으로 컴포넌트가 'unmount될 때 실행할 함수를 반환'
